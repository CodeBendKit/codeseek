class Codeseek < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/CodeBendKit/codeseek/releases/download/v0.1.14/codeseek-darwin-arm64"
      sha256 "d69412ba56a1d1e5a986ba39c8d1cd060594321cee2dd22344935e2c736aa62d"
    else
      url "https://github.com/CodeBendKit/codeseek/releases/download/v0.1.14/codeseek-darwin-x64"
      sha256 "48af60a85e047ba5e6fe338941485e2a18c52a5a28a1e9ea3482ea1affd3b147"
    end
  end

  on_linux do
    url "https://github.com/CodeBendKit/codeseek/releases/download/v0.1.14/codeseek-linux-x64"
